...
public class ConsolaOlimpicos
{
		...
		while (continuar)
		{
			try
			{
				...
				//OPCIÓN AGREGADA
					...
					ejecutarPaisRepresentadoPorAtleta();
	...
	/**
	 * CAMBIO AGREGADO
	 * Le muestra al usuario el país al cual representa un atleta determinado
	 */
	private void ejecutarPaisRepresentadoPorAtleta()
	{
		System.out.println("\n" + "País al cual que representa un atleta" + "\n");
		String nombre_del_atleta = input("Ingrese el nombre del atleta cuyo país quiere conocer");

		Map<String, String> pais = calculadora.PaisRepresentadoPorAtleta(nombre_del_atleta);
		if (pais.size() == 0)
		{
			System.out.println("No existe el atleta " + nombre_del_atleta + ". Por favor vuelva a intentarlo.");
		}
		else
		{
			System.out.println("El/La atleta " + nombre_del_atleta + " representa al país de " + pais.get(nombre_del_atleta) + ".");
		}
	}
