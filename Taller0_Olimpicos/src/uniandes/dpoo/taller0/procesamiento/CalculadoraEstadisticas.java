...
public class CalculadoraEstadisticas
{
	...
	/**
	 * CAMBIO AGREGADO
	 * Determina cuál es el país que representa un atleta que participó en los
	 * Olímpicos. Se emplea un mapa pues tiene complejidad O(1)
	 * 
	 * @param nombre_del_atleta El nombre del atleta ingresado por consola
	 */
	public Map<String, String> PaisRepresentadoPorAtleta(String nombre_del_atleta)
	{
		Map<String, String> resultado = new HashMap<String, String>();
		
		//Recorre los atletas y busca si hay coincidencia en el nombre
		for (Atleta atleta : atletas) 
		{
			//Emplea el método equals para comparar los nombres
			if (atleta.darNombre().equals(nombre_del_atleta))
			{
				Pais pais_del_atleta = atleta.darPais();
				String nombre_pais = pais_del_atleta.darNombre();
				resultado.put(nombre_del_atleta, nombre_pais);
			}
		}
		return resultado;
	}
